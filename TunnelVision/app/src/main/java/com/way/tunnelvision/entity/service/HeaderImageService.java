...
import com.way.tunnelvision.ui.activity.BackgroundActivity;
                    ...
                    headerImageModelImpl.loadHeaderImageList(new HeaderImageModelImpl.OnLoadHeaderImageListListener() {
                        ...
                        public void onSuccess(List<HeaderImageModel> list) {
                            if (list != null && list.size() > 0) {
                                ...
                                HeaderImageModel firstItem = list.get(0);
                                if(headerImageDaoHelper.hasEntity(firstItem)){
                                    ...
                                    Intent notificationIntent = new Intent(HeaderImageService.this, BackgroundActivity.class);//点击跳转位置
