...
public class ChannelDao extends AbstractDao<ChannelModel, Long> {
    ...
    public static class Properties {
        ...
        public final static Property ChannelChosen = new Property(5, Integer.class, PROPERTYNAME_CHOSEN, false, COLUMNNAME_CHOSEN);
    }
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"" + TABLENAME + "\" (" + //
                ...
                "\"" + COLUMNNAME_CHOSEN + "\" INTEGER NOT NULL);"); // 5: chosen
    }
    ...
    protected ChannelModel readEntity(Cursor cursor, int offset) {
        ChannelModel entity = new ChannelModel( //
                ...
                cursor.isNull(offset + 5) ? null : cursor.getInt(offset + 5) // chosen
    ...
    protected void readEntity(Cursor cursor, ChannelModel entity, int offset) {
        ...
        entity.setChannelChosen(cursor.isNull(offset + 5) ? null : cursor.getInt(offset + 5));
