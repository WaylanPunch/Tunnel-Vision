...
public class OkHttpUtil {
    ...
    private void getDownloadRequest(String url, final ResultCallback callback) {
        final Request request = new Request.Builder().url(url).build();
    ...
    public static void getDownload(String url, ResultCallback callback) {
        getmInstance().getDownloadRequest(url, callback);
    }
